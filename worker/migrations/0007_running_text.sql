-- Running Text Settings Migration for Cloudflare D1
-- Add running text configuration to theme_settings

-- Add running text columns to theme_settings
...
ALTER TABLE theme_settings ADD COLUMN running_text_bg_color TEXT DEFAULT NULL;
ALTER TABLE theme_settings ADD COLUMN running_text_text_color TEXT DEFAULT NULL;
